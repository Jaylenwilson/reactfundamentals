        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <dl>
                    ...
                    <dd>Theser are used to construct and update the DOM, or what you see on the screen</dd>
                    <dt>Not required</dt>
...
const CreateElementComponent = () => {
    return (
        React.createElement('div', { style: { border: '2px solid black' } },
            ...
            React.createElement('p', null, 'This was  constructed with createElement() in return'),
