const Resources = () => {
    return (
        <div className="mainDiv">
            ...
            <p>Belwo are some o the resources that we used throughtthis app.
            Note: You'll have one challenge where you be asked to make this page better
        </p>
            <ul>
                <li>
                ...
                <li>
                    <a href="https://www.udemy.com/course/react-the-guide-include-redux" target="_blank">
