        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <p>
                    ...
                    project and a learning sandbox for you in month and years to come should you continue
                    to develop software with React. In this application, we will work through some of the basic React concepts,
                    build out some small applications, and unleash you to build your own applications
        </p>
                <hr />
                ...
                <ul>
                    ...
                    <li>We have tried to collect the very best resources or this app, and we have cited those <Link to='/resources'>here</Link></li>
